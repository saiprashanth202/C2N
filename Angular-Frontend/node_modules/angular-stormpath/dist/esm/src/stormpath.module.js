...
export var StormpathModule = (function () {
    function StormpathModule() {
    }
    StormpathModule.decorators = [
        { type: NgModule, args: [{
                    declarations: [
                        AuthPortComponent,
    ...
    /** @nocollapse */
    StormpathModule.ctorParameters = function () { return []; };
    return StormpathModule;
}());
//# sourceMappingURL=stormpath.module.js.map